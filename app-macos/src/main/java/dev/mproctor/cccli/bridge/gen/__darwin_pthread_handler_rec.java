...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MyMacUI_h.C_POINTER.withName("__routine"),
        MyMacUI_h.C_POINTER.withName("__arg"),
        MyMacUI_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = MyMacUI_h.upcallHandle(__routine.Function.class, "apply", $DESC);
